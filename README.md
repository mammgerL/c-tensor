...
| 指标 | Apple Accelerate | OpenMP |
|------|------------------|--------|
| **总训练时间** | **6.26 秒** | 163.00 秒 |
| **平均每步耗时** | **0.31 ms** | 8.15 ms |
| **测试准确率** | 95.66% | 95.66% |
| **性能倍数** | **26x 更快** | 基准 |

> 测试环境：macOS, Apple Silicon, 20,000 训练步，批大小 128

### 结论

- **macOS 强烈推荐使用 Accelerate**（默认选项），性能提升约 26 倍
